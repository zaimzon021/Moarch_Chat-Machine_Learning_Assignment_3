# Moarch Chat: DeepSeek AI 💬 (Assignment 3)
...
* **Install the tools:** Run `pip install -r requirements.txt` to download the required libraries.
* **Start Chatting:** Just type `python app.py` in your terminal to boot up the chat interface!
